...
class EgoExoDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        ego_video_data = 0 #utils.load_and_transform_video_data([ego_video_filename], self.device, 2, 5)[0]
        exo_video_data =  0 #utils.load_and_transform_video_data([exo_video_filename], self.device, 2, 5)[0]
        #print(idx)
